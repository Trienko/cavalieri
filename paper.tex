...
It is therefore likely that this geometric interpretation would reduce the large jump 
students experience when they first encounter the Riemann-Stieltjes integral (i.e. make the 
...
of the Riemann-Stieltjes integral just as useful. It is also interesting to mention, that there is a few papers in literature that proposes to first 
teach simpler integral definitions (which are easier to grasp) before introducing students to the Riemann integral \cite{czarnocha2001,prabhu2008,ruffa2002,zaskis2014}. It therefore seems plausible that
students will find it useful to first understand the Cavalieri integral before the Riemann-Stieltjes integral is taught to them.
