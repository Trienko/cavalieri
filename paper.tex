...
\begin{itemize}
 \item $g(x_{i+1}^2)-g(x_{i}^2)$ represents the length of the base of a non-rectangular integration strip. Note, the base lengths in Fig.~\ref{fig:2d_geo} are all equal.
