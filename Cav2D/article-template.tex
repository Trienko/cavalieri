...
Moreover, the domain $R$ and the range $S$ of the transformation function $T$ which is associated with the solid $\mathcal{S}$ that is depicted in Figure~\ref{fig:prismatoid_solid} is depicted in Figure~\ref{fig:prismatoid_regions}.  
