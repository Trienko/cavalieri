...
c_y(t) = f(x_i^1 + c_x(t)).
\end{equation}
We can now solve for $t$ in Equation~\eqref{eq:t_func} in terms of $x_i^1$. If we substitute the solution $t(x_i)$ into Equation~\ref{eq:pat_rel} we obtain Equation~\ref{eq:h_func}.




In turns out that $h$ can be constructed 
