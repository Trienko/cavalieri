...
\caption{The solid depicted in Figure~\ref{fig:prismatoid_solid} is a prismatoid. We can, therefore, calculate its volume with the prismatoid volume equation: $V_{\mathcal{S}}$. If the 
areas of the two parallel faces are A1 and A3, the cross-sectional area of the intersection of the prismatoid with a plane midway between the two parallel faces is A2, 
and the height (the distance between the two parallel faces) is h, then the volume of the prismatoid is given by  }
