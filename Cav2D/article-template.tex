...
to Cavalieri's principle. Note that in this article we use the non-standerdized phrase non-linear rectangular prism or column to refer to a solid that has rectangular 
