...
and
\begin{equation}
y_{j}^2 = s(x_{i}^1,y_{j}^1) = \frac{3}{5} x_{i}^1 - \frac{2}{5} y_{j}^1 + \frac{16}{5}.  \nonumber
\end{equation}
...
irrgularly shaped rectangular infinitesimals. We end the paper with two fully worked out examples. In the first example we compute the 
