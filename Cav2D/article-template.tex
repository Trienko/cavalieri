...
$A1=$, $A2=$, $A3 = $ and $h=$. The volume of $\mathcal{S}$ is, therefore, $25.6$.}
...
\caption{The $xy$-projection of the solid $\mathcal{S}$ depicted in Figure~\ref{fig:sphere_solid} onto the $xy$-plane.}
\label{fig:sphere_xy}
\end{figure}
