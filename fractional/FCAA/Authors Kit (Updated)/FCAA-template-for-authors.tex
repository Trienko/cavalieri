...
\begin{itemize}
 \item $a(y) = f^{-1}(y)-\widetilde{g}\circ f^{-1}(y) + \widetilde{g}(a')$.
 \item $a = a(0)$.
 \item $C = a - \widetilde{g}(a')$.
 \item $g(x) = \widetilde{g}(x) + C$.
 \item $b = g(b')$ and $b(y) = a(y) + (b-a)$.
\end{itemize}
...
\end{equation}
Note, that for the example presented in this section $h(x) = \frac{1}{2}x$ and $g(x) = 2x$. 
