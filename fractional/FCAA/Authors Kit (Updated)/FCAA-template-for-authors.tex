...
{\it MSC 2010\/}: 26A33 and 26A42.%, 34A08, 34K37, 35R11, 60G22, ...
...
\noindent
In this article we specifically focus on the geometric interpretation of fractional integrals. To be more specific, we present a novel geometric interpretation of the left-sided Riemann-Liouville fractional integral based at $a'$ (see Section~\ref{sec:ls}) \cite{laurent1884}. We accomplish this by extending the geometric framework proposed by Podlubny \cite{podlubny02}.
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{gh.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\textwidth]{vis_old.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{geo_int1.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{func_eval1.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{geo_int2.pdf}
...
\bibitem{podlubny02} I.~Podlubny, Geometric and Physical Interpretation of Fractional Integration and Fractional Differentiation, \textit{Fract. Calc. Appl. Anal.} \textbf{5}, No 4 (2002), 367--386.
