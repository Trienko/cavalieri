...
Each of the regions depicted in Fig.~\ref{} are made up of an infinite number of infinitesimals, the shape of which is determined by their right edges, i.e. by the value 
of both $\alpha$ and $t$. The notion that $t$ alters the shape of the infinitesimals can easily be confirmed through visual inspection. The 
dashed grey curves and the solid grey-tinted curves in the right-most panel are not the same, i.e.$\mathsf{B}_T^{\alpha}\neq\mathcal{B}_T^{\alpha}$.
