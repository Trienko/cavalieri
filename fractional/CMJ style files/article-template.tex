...
$f(x)$ and $b_{10}^{\frac{4}{5}}(y)$. Region $A$ and $B$ are depicted in the rightmost panel of Fig ?? and Fig ??. Note that the curves $\{b_{t}^{\frac{4}{5}}(y)|t\in\{2,4,6,8,10\}\}$ are plotted 
using a greyscale. The shade with which $b_t^{\alpha}(y)$ is depicted becomes lighter as the value of $t$ increases.  is the lighter the curve associated with $b_t^{\alpha}(y)$ is.
