...
\end{equation}
Let $R_{10}^{\frac{4}{5}}$ denote the region which is bounded by the $x$-axis, the function $f(\tau)$ and the function $b_{10}^{\frac{4}{5}}(y)$. The region $R_{10}^{\frac{4}{5}}$ is depicted and labelled in the right-most panel of Figure.~\ref{??}. We are now in a position to assign a geometric 
...
The case in which we try to approximate the area of $R_{10}^{\frac{4}{5}}$ using only five non-rectangular integration strips of equal width is depicted in the right-most panel of Figure~\ref{??}. The sides of the 
aforementioned five integration strips are depicted in Fig.~\ref{??} using dahsed lines. Taking the limit of the aformentioned sum as $n\rightarrow \infty$ results in 
Eq??, i.e. the area of $R_{10}^{\frac{4}{5}}$. 

In the limit this sum approaches the area of $R_{10}^{\frac{4}{5}}$
