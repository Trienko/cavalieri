...
\begin{equation}
I^3f(x) = \int_0^x (x-t)t~dt = \frac{t^2x}{2} - \frac{t^3}{3} \Bigg |_0^x = \frac{x^3}{3!}.
\end{equation}
...
\end{equation}
Equation~\ref{eq:frac_integral} is known as the Riemann-Liouville fractional integral of order $\alpha$.
\subsection{Examples}
If $f(x)=x$ and $n=3$ then Equation~\ref{eq:frac_integral} reduces to:
\begin{equation}
I^3f(x) = \frac{1}{2!} \int_0^x (x-t)^2t~dt = \frac{1}{2}\left[\frac{t^4}{4} - \frac{2t^3}{3}+\frac{t^2x^2}{2}\right] \Bigg |_0^x = \frac{x^4}{4!} 
\end{equation}
