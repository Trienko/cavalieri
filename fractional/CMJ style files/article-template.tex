...
\centering
 \begin{tabular}{||c c c||} 
 \hline
 $\alpha$ & $\int_0^t \tau(t-\tau)^{\alpha-1}~d\tau$ & Col2 \\[0.5ex]
 \hline\hline
 \rule{0pt}{2.5ex}
 $0$ & $t$ & 87837  \\  
 \rule{0pt}{2.5ex}
 $0.2$ & $\frac{25}{6\Gamma(\frac{1}{5})} t^{\frac{6}{5}}$  & 78  \\ 
 \rule{0pt}{2.5ex}
 $0.4$ & $\frac{25}{14\Gamma(\frac{2}{5})} t^{\frac{7}{5}}$  & 778  \\
 \rule{0pt}{2.5ex}
 $0.6$ & $\frac{25}{24\Gamma(\frac{3}{5})} t^{\frac{8}{5}}$  & 18744  \\ 
 \rule{0pt}{2.5ex}
 $0.8$ & $\frac{25}{36\Gamma(\frac{4}{5})} t^{\frac{9}{5}}$  & 788  \\ 
 \rule{0pt}{2.5ex}
 $1$ & $\frac{1}{2}t^2$  & 788  \\ [1ex]
 \hline
 \end{tabular}
\end{table}
