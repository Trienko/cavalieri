...
If we take the limit of the aforementioned sum as $n\rightarrow \infty$ we approach $A_{10}^{\sfrac{4}{5}}$, i.e. the result obtained via the aforementioned limit is the Cavalieri integral found in Eq.~\eqref{eq:ex1_specific}. This then verifies 
the assertion we made earlier. Eq.~\eqref{eq:ex1_specific}, therefore, implies that the region $R_{10}^{\sfrac{4}{5}}$ is made up 
...
\begin{abstract}
In this paper we present a novel geometric interpetation of the Riemann-Liouville fractional integral. We found that a Riemann-Liouville integral can 
...
order of integration $\alpha$ and the integration limit $t$. We also emphasize the pedagogical benefits that this interpretation offers, as it is very 
similar in nature to the geometric interpretation that is associated with classic Riemann integrals.   
\end{abstract}
