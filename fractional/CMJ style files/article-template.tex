...
The gamma function is defined for all real numbers except for the non-negative integers. Moreover, it is a natural extends the factorial of an integer 
to any real number. The Gamma function is defined as:
\begin{equation}
