...
We, however, do not discuss them any further in this article. Investigating whether one can apply the proposed framework to other fractional integral definitions will be presented in future work. The geometric interpretation we present in this paper is an extension of the fractional geometric framework presented by Podlubny \cite{podlubny02}. Podlubny showed that a fractional Riemann-Liouville 
...
non-rectangular infinitesimels, i.e. a Riemann-Stieltjes integral can be converted into a Cavalieri integral \cite{ackermann12,?}. Combining these two ideas together results in the following geometric 
