...
To make things clearer lets set the value of $\alpha$ to $0.8$ and the value of $t$ to 10 and then depict the region associated that is associated with the Cavalieri integral which is obtained 
