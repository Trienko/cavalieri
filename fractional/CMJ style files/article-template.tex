...
It is, however, Liouville and Riemann who laid the theoretical groundwork which was needed to develop the field of fractional calculus. 
Their contribution played a crucial part in defining what is now known as the Riemann-Lioville fractional integral. Fractional calculus can be 
formally defined as the study of a an arbitrary order differentiation and integration operators.
...
interpretation of the fractional integral. Interestingly in 1974, this had already been the state of affairs for more than 300 years []. Subsequently, the last few decades has seen a number of papers that attempt to rectify this. There now exists probabilistic interpretations, 
