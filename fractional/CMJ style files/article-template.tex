...
It can be argued that fractional calculus is as old as classical calculus itself. The father of calculus, Leibnis, mentiones the notion of a fractional 
order derivative in a letter he sent to L'Hospital. In this letter he answers a question L'Hospital poses. Liouville and Riemann laid much of the groundwork which was 
needed to define the Riemann-Liouville fractional integral [Laurent’]. 
...
interpretation of the fractional integral []. Consequently the last few decades has seen a number of papers that attempt to rectify this. There now exists probabilistic interpretations, 
geometric interpretations and ecenomic interpretations of the fractional integral. 

In this paper we present a novel geometric interpretation of the Riemann-Liouville fractional integral. The interpretation we present here is quite useful from 
a pedigogical point of view as 
