...
\end{equation}
This integral can be interpreted as the area of the region bounded by the $x$-axis, the function $f(\tau)$ and the function $b_{10}^{\frac{4}{5}}(y)$. Let us denote 
this region with the symbol $R_{10}^{\frac{4}{5}}$. The region $R_{10}^{\frac{4}{5}}$ is depicted and labelled in the right-most panel of Figure.~\ref{??}. We are now in a position to assign a geometric 
interpretaion to Eq.~\eqref{}. We can approximate the area of $R_{10}^{\frac{4}{5}}$
by summing together the area of non-rectangular integration strips that inscribe $R_{10}^{\frac{4}{5}}$. The only resctriction being: the sides of these non-rectangualar integration strips have to be translations of $b_{10}^{\frac{4}{5}}(y)$.
Lets now choose to approximate the area of $R_{10}^{\frac{4}{5}}$ using five integration strips of equal width. The aformentioned integration strips are depicted in the right-most panel of Figure~\ref{??}.
