...
Moreover, let $A_{10}^{\sfrac{4}{5}}$ denote the area of $R_{10}^{\sfrac{4}{5}}$. We are now in a position to assign a geometric interpretation to Eq.~\eqref{eq:ex1_specific} as it 
contains a Cavalieri integral. We can approximate the area of $A_{10}^{\sfrac{4}{5}}$ by summing together the area of $n$ equal width non-rectangular integration strips that inscribe $R_{10}^{\sfrac{4}{5}}$. 
